...
final class NewEventHeader: UICollectionReusableView {
    // MARK: - UI properties
    private let sectionLabel: UILabel = .init().then {
        let attributedString = NSMutableAttributedString(string: "신규이벤트")
    ...
    // MARK: - Properties
    static let identifier: String = "NewEventHeader"
